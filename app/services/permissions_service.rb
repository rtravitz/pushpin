class PermissionsService
  ...
  private
    ...
    def admin_permissions
      ...
      return true if controller == "admin/users" && action.in?(%w(update destroy show))
      ...
      return true if controller == "admin/proposals"
      return true if controller == "admin/projects"
    end
